...
*/  
           for (let i = 0; i < estadosNe.length; i++){
                calcDem = densidade(estadosNe[i].area,estadosNe[i].populacao) 
                estadosNe[i]['densidade demografica'] =  calcDem.toFixed(3)
